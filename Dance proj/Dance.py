...
right = Actor("right")
right.pos = CENTRE_X, CENTRE_Y + 170
down = Actor("down")
down.pos = CENTRE_X, CENTRE_X + 230
left = Actor("left")
left.pos = CENTRE_X, CENTRE_Y + 170
...
def update_dancer(move):
    ...
    if not game_over:
        if move == 0:
            ...
            clock.schedule(reset_dancer, 5.0)
        elif move == 2:
            down.image = "down-lit"
